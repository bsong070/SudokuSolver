...
suite('Functional Tests', () => {
  suite('POST request to /api/solve', () => {
    ...
    test('Solve a puzzle with invalid characters: POST request to /api/solve', (done)=>{
      let puzzle = 'x.5..2.84..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9x4x...8..1..16....926914.3x.'
      chai.request(server)
      .post('/api/solve/')
      .send({puzzle: puzzle, row:0, col:0})
      .end((err,res)=>{
    ...
    test('Solve a puzzle that cannot be solved: POST request to /api/solve', (done)=>{
      let puzzle = '1.1..1.11..63.12.7.2..5.....9..1....8.2.3674.3.7.2..9.47...8..1..16....926914.37.'
      chai.request(server)
        .post('/api/solve')
        .send({puzzle:puzzle,row:0,col:0})
        .end((err,res)=>{
    ...
    test('Check a puzzle placement with all placement conflicts: POST request to /api/check', (done)=>{
      ...
      chai.request(server)
        .post('/api/check/')
        .send({puzzle:puzzle, coordinate: 'E8', value: 3})
        .end((err,res)=>{
          assert.equal(res.status,200)
          assert.property(res.body,'conflict')
          assert.property(res.body,'valid')
